...
<head>
    ...
    <style>
      .modal-header {background:#D2691E;color:#fff;font-weight:800;}
      .modal-body{font-weight:800;}
      .modal-body ul{list-style:none;}
      .modal .btn {background:#006400;color:#006400;}
      ...
      .modal-backdrop {position:inherit !important;}
       ...
       #query_button {position:fixed;right:0px;bottom:0px;padding:10px 80px;
                      background-color: #00008B;color:#fff;border-color:#f05f40;border-radius:2px;}
      ...
      <div class="container-fluid" id="header">
          <div class="row">
              <div class="col-md-3 col-lg-3" id="category">
                  <div style="background:#006400;color:#fff;font-weight:800;border:none;padding:15px;"> The Book Shop </div>
                  <ul>
